const CACHE='tool-dash-v3';const CORE=['./','index.html','styles.css','app.js','manifest.webmanifest','assets/icon.svg','vendor/ort.min.js','vendor/ort-wasm-simd-threaded.mjs','vendor/ort-wasm-simd-threaded.wasm','assets/yolov8n.onnx'];
