const CACHE='tool-dash-v4';const CORE=['./','index.html','styles.css','app.js','manifest.webmanifest','assets/icon.svg','vendor/ort.min.js','vendor/ort-wasm-simd.wasm','assets/yolov8n.onnx'];
